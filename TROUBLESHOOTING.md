...
Common issues and solutions when working with acton-service.
...
### Error: "cannot find type `AppState` in this scope"
...
### Error: "method `database` not found in this scope"
...
```toml
[dependencies]
acton-service = { version = "0.3", features = ["http", "observability", "database"] }
```

### Error: "could not find `tonic` in the list of imported crates"
...
### Error: "trait `IntoResponse` is not implemented"
...
### Error: "cannot infer type for type parameter `S`"
...
### Error: "Cannot find example `simple-api`"
...
The [examples directory](./acton-service/examples/) has working code for most features.

### Get help

- [GitHub Issues](https://github.com/Govcraft/acton-service/issues)
- [API Documentation](https://docs.rs/acton-service)
- Check [TUTORIAL.md](./TUTORIAL.md) for step-by-step guides
