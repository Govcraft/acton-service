...
How acton-service compares to popular Rust web frameworks.
...
**Note**: Performance depends heavily on your application logic. These are rough estimates for simple CRUD operations.
...
- [QUICKSTART.md](./QUICKSTART.md) - Get started with acton-service
- [TUTORIAL.md](./TUTORIAL.md) - Build your first service
- [FEATURE_FLAGS.md](./FEATURE_FLAGS.md) - Understand features
- [examples/](./acton-service/examples/) - Working code examples
