...
/// JWT Authentication interceptor factory
///
...
/// Simple authentication interceptor (deprecated - use jwt_auth_interceptor instead)
///
/// This is kept for backward compatibility but doesn't perform actual validation.
#[deprecated(since = "0.2.0", note = "Use jwt_auth_interceptor instead")]
