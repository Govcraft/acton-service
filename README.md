...
```toml
[dependencies]
acton-service = { version = "0.40", features = ["mssql"] }
```
...
```toml
[dependencies]
acton-service = { version = "0.40", features = ["windows-auth"] }
```
...
```toml
[dependencies]
acton-service = { version = "0.40", features = ["grpc", "database", "cache"] }
```
...
```toml
[dependencies]
acton-service = { version = "0.40", features = ["full"] }
```
...
```toml
[dependencies]
acton-service = { version = "0.40", default-features = false, features = [
    "http",
    "observability",
    "crypto-ring",
] }
