...
```toml
[dependencies]
acton-service = { version = "0.35", features = ["grpc", "database", "cache"] }
```
...
```toml
[dependencies]
acton-service = { version = "0.35", features = ["full"] }
```
...
```toml
[dependencies]
acton-service = { version = "0.35", default-features = false, features = [
    "http",
    "observability",
    "crypto-ring",
] }
